...
export const experiences = [
  {
    ...
    desc: `1.
     Working on Universal tasker Platforms, managing and communicating between users and clients, and streamlining the process where users can easily find their respective job and client can get their best resources to complete their respective work. 
     Developing and maintaining React Native applications across various domains.
     Collaborating with cross-functional teams to deliver high-quality software solutions.
     Utilizing React Native, ReactJS, JavaScript, Tailwind CSS, HTML5, and CSS3.
...
export const education = [
  {
    ...
    degree: "Master of Computer Application - MCA, Computer Application and Engineering",
  },
  {
    id: 1,
